...
class StockPriceUtilsTest {
    @Test
    void should_find_max_profit() {
        Assertions.assertThat(StockPricesUtils.maxProfit(new int[]{4, 1, 3, 3, 5, 2})).isEqualTo(4);
    }

    @Test
    void should_find_max_profit_multiple() {
        Assertions.assertThat(StockPricesUtils.maxProfitMultiple(new int[]{4, 1, 3, 3, 5, 2})).isEqualTo(4);
    }

    @Test
    void should_not_find_max_profit_multiple() {
        Assertions.assertThat(StockPricesUtils.maxProfitMultiple(new int[]{4, 3, 2, 1})).isEqualTo(0);
    }

    @Test
    void should_find_max_profit_with_fee() {
        Assertions.assertThat(StockPricesUtils.maxProfitMultipleWithFee(new int[]{1, 3, 2, 8, 4, 9}, 2)).isEqualTo(8);
    }

    @Test
    void should_find_max_profit_with_cooldown() {
        Assertions.assertThat(StockPricesUtils.maxProfitWithCooldown(new int[]{1, 2, 3, 0, 2})).isEqualTo(3);
    }

    @Test
    void should_find_max_profit_with_cooldown_at_large_data() {
        Assertions.assertThat(StockPricesUtils.maxProfitWithCooldown(
